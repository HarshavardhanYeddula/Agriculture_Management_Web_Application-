...
if(isset($_POST['submit']))
{
	...
	$subject = "Message from FarmAssist";		
	$message = "<html>
	<head>
	<title>FarmAssist Contact Us form</title>
	</head>
	<body>
	<p>FarmAssist Contact Us form</p>
	<table>
	<tr>
	<th>Name</th>
	<td>$_POST[name]</td>
        ...
        <div class="row">
          ...
          <div class="col-lg-12" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="info mt-4">
              ...
              <h4>Location:</h4>
              <p>Knowledge park-3, Greater Noida, Uttar Pradesh, India</p>
            </div>
            <div class="row">
